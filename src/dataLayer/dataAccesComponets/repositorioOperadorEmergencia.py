"""
Repositorio de acceso a datos para Operadores de Emergencia.

Proporciona operaciones CRUD usando SQLAlchemy y mapea hacia/desde
la entidad Pydantic `OperadorEmergencia` de la capa de negocio.
"""
...
from src.dataLayer.models.modeloOperadorEmergencia import OperadorEmergencia as OperadorDB
from src.businessLayer.businessEntities.operadorEmergencia import OperadorEmergencia as OperadorBE
...
def crear_operador(operador: OperadorBE) -> Optional[OperadorBE]:
    """
    Crea un operador de emergencia. Devuelve el modelo Pydantic con el id asignado.
